...
class DrawerListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by DrawerParser#nopExpr.
    def enterNopExpr(self, ctx:DrawerParser.NopExprContext):
        pass

    # Exit a parse tree produced by DrawerParser#nopExpr.
    def exitNopExpr(self, ctx:DrawerParser.NopExprContext):
        pass
    ...
    # Enter a parse tree produced by DrawerParser#op1Expr.
    def enterOp1Expr(self, ctx:DrawerParser.Op1ExprContext):
        pass

    # Exit a parse tree produced by DrawerParser#op1Expr.
    def exitOp1Expr(self, ctx:DrawerParser.Op1ExprContext):
        pass


    # Enter a parse tree produced by DrawerParser#op2Expr.
    def enterOp2Expr(self, ctx:DrawerParser.Op2ExprContext):
        pass

    # Exit a parse tree produced by DrawerParser#op2Expr.
    def exitOp2Expr(self, ctx:DrawerParser.Op2ExprContext):
        pass
